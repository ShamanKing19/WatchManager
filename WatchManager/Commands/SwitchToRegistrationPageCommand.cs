...
{
    public class SwitchToRegistrationPageCommand : CommandBase
    {
        private NavigationStore _navigtationStore;
        private Func<BaseViewModel> _createViewModel;

        public SwitchToRegistrationPageCommand(NavigationStore navigtationStore, Func<BaseViewModel> createViewModel)
        {
